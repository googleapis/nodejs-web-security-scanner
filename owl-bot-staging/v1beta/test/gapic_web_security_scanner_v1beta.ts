...
describe('v1beta.WebSecurityScannerClient', () => {
    ...
    describe('createScanConfig', () => {
        it('invokes createScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.CreateScanConfigRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ScanConfig());
    ...
    describe('deleteScanConfig', () => {
        it('invokes deleteScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.DeleteScanConfigRequest());
            request.name = '';
    ...
    describe('getScanConfig', () => {
        it('invokes getScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.GetScanConfigRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateScanConfig', () => {
        it('invokes updateScanConfig without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.UpdateScanConfigRequest());
            request.scanConfig = {};
    ...
    describe('startScanRun', () => {
        it('invokes startScanRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.StartScanRunRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ScanRun());
    ...
    describe('getScanRun', () => {
        it('invokes getScanRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.GetScanRunRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('stopScanRun', () => {
        it('invokes stopScanRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.StopScanRunRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('getFinding', () => {
        it('invokes getFinding without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.GetFindingRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.Finding());
    ...
    describe('listFindingTypeStats', () => {
        it('invokes listFindingTypeStats without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListFindingTypeStatsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListFindingTypeStatsResponse());
    ...
    describe('listScanConfigs', () => {
        it('invokes listScanConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListScanConfigsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listScanRuns', () => {
        it('invokes listScanRuns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListScanRunsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listCrawledUrls', () => {
        it('invokes listCrawledUrls without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListCrawledUrlsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.websecurityscanner.v1beta.ListFindingsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
