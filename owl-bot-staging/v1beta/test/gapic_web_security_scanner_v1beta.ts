...
describe('v1beta.WebSecurityScannerClient', () => {
    ...
    describe('createScanConfig', () => {
        it('invokes createScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateScanConfigRequest', ['parent']);
    ...
    describe('deleteScanConfig', () => {
        it('invokes deleteScanConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteScanConfigRequest', ['name']);
    ...
    describe('updateScanConfig', () => {
        it('invokes updateScanConfig without error', async () => {
            ...
            request.scanConfig ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateScanConfigRequest', ['scanConfig', 'name']);
    ...
    describe('startScanRun', () => {
        it('invokes startScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StartScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getScanRun', () => {
        it('invokes getScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.websecurityscanner.v1beta.ScanRun()
    ...
    describe('stopScanRun', () => {
        it('invokes stopScanRun without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('StopScanRunRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.websecurityscanner.v1beta.ScanRun()
    ...
    describe('getFinding', () => {
        it('invokes getFinding without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetFindingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listFindingTypeStats', () => {
        it('invokes listFindingTypeStats without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListFindingTypeStatsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listScanRuns', () => {
        it('invokes listScanRuns without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListScanRunsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listCrawledUrls', () => {
        it('invokes listCrawledUrls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListCrawledUrlsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listFindings', () => {
        it('invokes listFindings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListFindingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
